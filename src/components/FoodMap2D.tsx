...
export default function FoodMap2D({ selectedPin, selectedIngredient, hoveredIngredient, onPinClick, onIngredientClick, onIngredientHover }: FoodMapProps) {
  ...
  useEffect(() => {
    ...
    overlayRef.current.setProps({
      layers: buildLayers(selectedPin, selectedIngredient, hoveredIngredient, onIngredientClick, onIngredientHover),
    });
  }, [mapReady, selectedPin, selectedIngredient, hoveredIngredient, onIngredientClick, onIngredientHover]);
  ...
  useEffect(() => {
    ...
    for (const ing of selectedPin.ingredients) {
      ...
      for (const pts of segments) {
        ...
        polyline.addListener("mouseover", () => onIngredientHover(ing));
        polyline.addListener("mouseout", () => onIngredientHover(null));
        hitPolylinesRef.current.push(polyline);
      }
    }
  }, [mapReady, selectedPin, onIngredientClick, onIngredientHover]);
